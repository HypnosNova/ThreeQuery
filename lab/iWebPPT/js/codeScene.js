function createCodeScene() {
	...
	function init() {
		...
		var font = UbuntuMono('font/UbuntuMono.png');
...
//		console.log(links[0])
		links[0].bg.onClick=function(){
			...
			var transition = new $$.Transition(mainScene, {}, $$.Loader.RESOURCE.textures["transition/transition4.png"]);
