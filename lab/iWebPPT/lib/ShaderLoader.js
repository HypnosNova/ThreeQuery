  ...
  */
  ShaderLoader.prototype.loadShaderChunk = function( type ){
    ...
    xmlhttp.onreadystatechange=function(){
    	self.onChunkLoaded( xmlhttp.responseText , type);
    };
...
//  });
  ...
  */
  ShaderLoader.prototype.load = function( shader , title , type ){
    ...
    var self = this;
		var path=self.pathToShaders +"/" + shader + ".glsl";
    this._beginLoad(  shader , title , type );

//		var xmlhttp=new XMLHttpRequest();
//  xmlhttp.onreadystatechange=function(){
////  	console.log(xmlhttp.responseText)
//  	self.onShaderLoaded( xmlhttp.responseText , title , type );
//  };
//		xmlhttp.open("GET",path,true);
//		xmlhttp.send(null);
...
//      self.onShaderLoaded( r.responseText , title , type );
//    }
//  });
